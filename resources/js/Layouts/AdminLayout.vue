        ...
        <aside
            ...
            <div>
                ...
                <ul class="space-y-2 tracking-wide mt-8">
                    <li>
                        <SidebarLink href="/dashboard" :active="false" aria-label="dashboard">
            ...
            <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
                <Link :href="route('logout')" method="POST" as="button" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover:text-red-600" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
